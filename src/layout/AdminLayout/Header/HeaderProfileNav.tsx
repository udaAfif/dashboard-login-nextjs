          ...
          <Link href="/" passHref>
            <Dropdown.Item>
              <ProfileDropdownItem icon={faListCheck}>
                Tasks
                <Badge bg="danger" className="ms-2">10</Badge>
              </ProfileDropdownItem>
            </Dropdown.Item>
          </Link>
          <Link href="/" passHref>
            <Dropdown.Item>
              <ProfileDropdownItem icon={faMessage}>
                Messages
                <Badge bg="warning" className="ms-2">12</Badge>
              </ProfileDropdownItem>
            </Dropdown.Item>
          </Link>
